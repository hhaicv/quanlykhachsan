                                ...
                                <div class="product-detail_item">
                                    <div class="img">
                                        <a href="#"><img style="height: 180px;"
                                                src="{{ Storage::url($item->cover) }}" alt="#"></a>
                                    </div>
                                    <div class="text">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-child" aria-hidden="true"></i> Tối đa:
                                                {{ $item->max_people }}</li>
                                            <li><i class="fa fa-bed" aria-hidden="true"></i> Giường:
                                                {{ \Str::limit($item->bed, 15) }}</li>
                                            <li><i class="fa fa-eye" aria-hidden="true"></i> View:
                                                {{ \Str::limit($item->view, 20) }}</li>
                                        </ul>
                                        <a href="{{ route('show', $item->id) }}" class="btn btn-room">VIEW DETAIL</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
